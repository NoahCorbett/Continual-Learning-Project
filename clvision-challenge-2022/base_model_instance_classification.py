...
TRAINING_JSON = 'ego_objects_demo_train - 15 classes.json'
TESTING_JSON = 'ego_objects_demo_test - 15 classes.json'
...
def main(args):
    ...
    model = torch.nn.Sequential(
        pytorchcv.models.regnet.regnetx016(pretrained=True),
        torch.nn.Softmax(1)
    )
    """
